/**
 * @casys/mcp-platform — Hono-style framework for MCP servers
 *
...
// Dropping the convenience re-export removes @casys/mcp-platform's dependency on
