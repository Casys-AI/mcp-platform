...
([`@casys/mcp-server`](../server/README.md)) so new consumers can install the platform under its own
name. Both entries expose the exact same API.
...
See [`@casys/mcp-server`](../server/README.md) for the full documentation and API reference.
